...
contract MutantInvisibleFrens is ERC721, Ownable {
    uint256 public constant MAX_SUPPLY = 700;
    uint256 private mintCount = 0;

    uint256 public price = 84000000000000000;
    string baseTokenURI;
    bool public saleOpen = false;

    event Minted(uint256 totalMinted);

    constructor(string memory baseURI) ERC721("Mutant Invisible Frens", "MIF") {
        setBaseURI(baseURI);
    }
