...
contract SocialCoolCats is ERC721, Ownable {
    uint256 public constant MAX_SUPPLY = 876;
    uint16 private mintCount = 0;

    uint256 public price = 87600000000000000;
    string baseTokenURI;
    bool public saleOpen = false;

    event Minted(uint256 totalMinted);

    constructor(string memory baseURI) ERC721("Social Cool Cats", "SCA") {
        setBaseURI(baseURI);
    }
